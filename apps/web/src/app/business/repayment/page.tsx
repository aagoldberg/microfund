    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="pl-7 block w-full border-gray-300 rounded-md shadow-sm focus:ring-viridian-500 focus:border-viridian-500 sm:text-sm"
              placeholder="10000"
            />
          </div>
        </div>
        ...
        <button
          ...
          className="w-full bg-viridian-600 text-white py-2 px-4 rounded-md hover:bg-viridian-700 focus:outline-none focus:ring-2 focus:ring-viridian-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
        >
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Info Banner */}
        <div className="bg-viridian-50 border border-viridian-200 rounded-lg p-4 mb-6">
          <div className="flex">
            <div className="flex-shrink-0">
              <svg className="h-5 w-5 text-viridian-400" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
              </svg>
            </div>
            <div className="ml-3">
              <p className="text-sm text-viridian-800">
