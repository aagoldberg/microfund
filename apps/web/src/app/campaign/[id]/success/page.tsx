    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                {/* Transaction Details */}
                {txHash && (
                    <div className="bg-viridian-50 border border-viridian-200 rounded-xl p-6 mb-8">
                        <h3 className="text-lg font-semibold text-viridian-900 mb-3">Transaction Details</h3>
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm text-viridian-700 mb-1">Transaction Hash:</p>
                                <p className="text-viridian-900 font-mono text-sm">{txHash.slice(0, 20)}...{txHash.slice(-10)}</p>
                            </div>
                            <a
                                href={`https://sepolia.basescan.org/tx/${txHash}`}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="bg-viridian-600 text-white px-4 py-2 rounded-lg hover:bg-viridian-700 transition-colors text-sm font-medium"
                            >
                                View on Explorer →
                            </a>
                        </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link
                            ...
                            className="bg-viridian-600 text-white px-8 py-3 rounded-xl font-semibold hover:bg-viridian-700 transition-colors inline-flex items-center justify-center gap-2"
                        >
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
