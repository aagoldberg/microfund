...
export default function UnifiedPaymentButton({
  ...
  onSuccess,
  onError,
  className = "w-full bg-viridian-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-viridian-700 disabled:bg-gray-400 disabled:cursor-not-allowed"
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-viridian-50 border border-viridian-200 rounded-lg p-3">
        <div className="text-xs text-viridian-800">
          {selectedMethod === 'wallet' && (
            <>
              ...
              {(usdcPayment.isApproving || usdcPayment.isContributing) && (
                <div className="mt-2 text-viridian-700 font-medium">
