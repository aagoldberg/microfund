      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="md:hidden flex items-center justify-between h-16">
          <Link href="/" className="flex items-center">
            <span className="text-4xl text-primary-600 font-uni-sans" style={{ fontWeight: 900 }}>Yunus</span>
          </Link>
                  ...
                  {!authenticated && (
                    <div className="w-full">
                      <Link
                        ...
                        className="block btn-primary text-center px-4 py-3 font-bold rounded-xl no-underline"
                        onClick={() => setMobileMenuOpen(false)}
                      >
                        Get Started
                      </Link>
        ...
        <div className="hidden md:flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0 flex items-center space-x-3">
            <Link href="/create-campaign" className="btn-primary py-2.5 px-4 rounded-xl">
              Get Started
            </Link>
            {!ready ? (
              ...
              <button
                ...
                className="bg-white hover:bg-gray-50 text-gray-700 font-medium py-2.5 px-5 border border-gray-200 rounded-xl shadow-sm transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary-600 focus:ring-opacity-20"
              >
                Login
              </button>
            )}
