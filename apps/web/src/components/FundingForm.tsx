...
import LendingPaymentOptions from './LendingPaymentOptions';
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 max-w-lg mx-auto">
            ...
            <div className="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div className="relative flex items-center p-4 border-2 border-gray-200 rounded-xl focus-within:border-primary-500 transition-all bg-gray-50">
                ...
                {/* Payment options */}
                <div>
                    <LendingPaymentOptions
                        loanAddress={campaignId}
                        usdcAmount={parseFloat(amount) || 0}
                        onSuccess={onSuccess}
                        onError={onError}
                    />
                </div>
            ...
            <div className="px-6 pb-6">
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    <div className="flex items-start">
                        ...
                        <div>
                            <h4 className="text-sm font-medium text-yellow-800 mb-1">Lending Risk</h4>
                            <p className="text-xs text-yellow-700">
                                Microloans involve risk. Only lend what you can afford to lose.
                                Repayment depends on borrower's ability to repay and is not guaranteed.
                            </p>
                        </div>
                    </div>
                </div>
